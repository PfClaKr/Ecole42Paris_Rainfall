...
Dump of assembler code for function main:
   ...
   0x08048491 <+21>:    mov    %eax,0x1c(%esp) # save return value of malloc in 0x1c(%esp)
   0x08048495 <+25>:    movl   $0x4,(%esp)
   0x0804849c <+32>:    call   0x8048350 <malloc@plt> # malloc(4)
   0x080484a1 <+37>:    mov    %eax,0x18(%esp) # save return value of malloc in 0x18(%esp)
   0x080484a5 <+41>:    mov    $0x8048468,%edx # function m
   0x080484aa <+46>:    mov    0x18(%esp),%eax
   0x080484ae <+50>:    mov    %edx,(%eax) # save the function in variable 0x18(%esp)
   0x080484b0 <+52>:    mov    0xc(%ebp),%eax # take **av
   0x080484b3 <+55>:    add    $0x4,%eax # foward 4 bytes -> *av[1]
   0x080484b6 <+58>:    mov    (%eax),%eax # dereferencing
   0x080484b8 <+60>:    mov    %eax,%edx
   0x080484ba <+62>:    mov    0x1c(%esp),%eax # 0x1c, variable with malloc 64
   0x080484be <+66>:    mov    %edx,0x4(%esp) # av[1]
   0x080484c2 <+70>:    mov    %eax,(%esp)
   0x080484c5 <+73>:    call   0x8048340 <strcpy@plt> # strcpy(str, av[1])
   0x080484ca <+78>:    mov    0x18(%esp),%eax
   0x080484ce <+82>:    mov    (%eax),%eax # call the function variable
